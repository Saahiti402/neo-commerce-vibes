...
export const featuredProducts: Product[] = [
  {
    ...
    description: "Luxury genuine leather jacket with premium finish, modern cut, and superior craftsmanship. Perfect for both casual and formal occasions.",
    price: 299.99,
  ...
  },
  {
    ...
    description: "Elegant designer handbag crafted with premium materials, featuring spacious compartments and sophisticated design for the modern woman.",
    price: 199.99,
  ...
  },
  {
    ...
    description: "High-performance sneakers with advanced cushioning technology, breathable materials, and modern design for ultimate comfort.",
    price: 129.99,
    image: mensSneakers1,
    category: "footwear",
  ...
  },
  {
    ...
    description: "Exquisite handwoven silk saree with intricate patterns and vibrant colors, perfect for special occasions and festivals.",
    price: 179.99,
...
const generateProductCatalog = (): Product[] => {
  ...
  const productTemplates = {
    "mens-traditional": [
      { name: "Kurta", basePrice: 49.99, description: "Traditional cotton kurta with elegant design", brands: ["Heritage", "Tradition Plus", "Ethnic Wear"] },
      { name: "Dhoti", basePrice: 29.99, description: "Comfortable traditional dhoti in premium fabric", brands: ["Traditional Craft", "Ethnic Style"] },
      { name: "Sherwani", basePrice: 199.99, description: "Elegant sherwani for special occasions", brands: ["Royal Collection", "Wedding Wear"] },
      { name: "Nehru Jacket", basePrice: 79.99, description: "Classic Nehru jacket in various colors", brands: ["Classic Style", "Modern Traditional"] },
    ],
    "mens-western": [
      { name: "Casual Shirt", basePrice: 39.99, description: "Comfortable cotton shirt for daily wear", brands: ["ComfortWear", "Daily Style", "Urban Fit"] },
      { name: "Jeans", basePrice: 59.99, description: "Premium denim jeans with perfect fit", brands: ["DenimCo", "Blue Label", "Flex Jeans"] },
      { name: "T-Shirt", basePrice: 19.99, description: "Soft cotton t-shirt in various colors", brands: ["BasicWear", "Cotton Plus", "Comfort Zone"] },
      { name: "Chinos", basePrice: 49.99, description: "Stylish chinos for casual occasions", brands: ["Urban Style", "Casual Fit", "Modern Wear"] },
    ],
    "mens-casual": [
      { name: "Polo Shirt", basePrice: 34.99, description: "Classic polo shirt for casual outings", brands: ["Polo Club", "Casual Classic", "Sport Style"] },
      { name: "Cargo Pants", basePrice: 44.99, description: "Functional cargo pants with multiple pockets", brands: ["Adventure Wear", "Utility Style", "Outdoor Gear"] },
      { name: "Hoodie", basePrice: 54.99, description: "Comfortable hoodie for cool weather", brands: ["Comfort Zone", "Street Style", "Urban Casual"] },
      { name: "Shorts", basePrice: 24.99, description: "Breathable shorts for summer comfort", brands: ["Summer Wear", "Cool Comfort", "Active Style"] },
    ],
    "mens-formal": [
      { name: "Business Suit", basePrice: 299.99, description: "Professional business suit with perfect tailoring", brands: ["Executive Style", "Business Elite", "Corporate Wear"] },
      { name: "Dress Shirt", basePrice: 49.99, description: "Crisp dress shirt for formal occasions", brands: ["Formal Plus", "Executive Shirt", "Business Style"] },
      { name: "Blazer", basePrice: 149.99, description: "Elegant blazer for business meetings", brands: ["Professional Wear", "Business Class", "Executive Style"] },
      { name: "Formal Trousers", basePrice: 69.99, description: "Well-tailored formal trousers", brands: ["Formal Fit", "Business Wear", "Office Style"] },
    ],
    "womens-traditional": [
      { name: "Saree", basePrice: 89.99, description: "Beautiful traditional saree in premium fabric", brands: ["Heritage Weaves", "Traditional Silk", "Ethnic Collection"] },
      { name: "Salwar Kameez", basePrice: 69.99, description: "Elegant salwar kameez set with dupatta", brands: ["Ethnic Elegance", "Traditional Wear", "Heritage Style"] },
      { name: "Lehenga", basePrice: 199.99, description: "Stunning lehenga for special occasions", brands: ["Bridal Collection", "Festive Wear", "Royal Heritage"] },
      { name: "Kurti", basePrice: 39.99, description: "Stylish kurti for daily traditional wear", brands: ["Daily Traditional", "Ethnic Comfort", "Modern Heritage"] },
    ],
    "womens-western": [
      { name: "Jeans", basePrice: 59.99, description: "Trendy women's jeans with perfect fit", brands: ["Fashion Denim", "Style Co", "Trendy Fit"] },
      { name: "Dress", basePrice: 79.99, description: "Elegant dress for various occasions", brands: ["Fashion Forward", "Style Statement", "Elegant Wear"] },
      { name: "Top", basePrice: 34.99, description: "Stylish top in contemporary design", brands: ["Modern Style", "Fashion Plus", "Trendy Tops"] },
      { name: "Skirt", basePrice: 44.99, description: "Fashionable skirt in various lengths", brands: ["Style Central", "Fashion Hub", "Trendy Wear"] },
    ],
    "womens-casual": [
      { name: "Casual Dress", basePrice: 49.99, description: "Comfortable dress for everyday wear", brands: ["Casual Comfort", "Daily Style", "Easy Wear"] },
      { name: "Jeggings", basePrice: 39.99, description: "Comfortable jeggings with stretch fabric", brands: ["Comfort Fit", "Stretch Style", "Flexible Wear"] },
